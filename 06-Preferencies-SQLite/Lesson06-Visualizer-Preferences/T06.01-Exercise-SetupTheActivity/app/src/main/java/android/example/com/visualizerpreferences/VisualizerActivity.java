...
public class VisualizerActivity extends AppCompatActivity {
    ...
    // Completed (1) Create a new Empty Activity named android.example.com.visualizerpreferences.SettingsActivity; make sure to generate the
    ...
    // Completed (6) When the "Settings" menu item is pressed, open android.example.com.visualizerpreferences.SettingsActivity


    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        int index = item.getItemId();
        if(index == R.id.action_settings){
